...
This specific version is an adaptation to Visual C# 2010 Express!
...
## Framework Support
** This specific version of SSH.NET** supports the following target frameworks:
* .NET Framework 4.0 
...
Use Visual C# 2010 Express or Visual Studio 2010 to build for the .NET Framework 4.0.
